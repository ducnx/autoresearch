...
class LiteratureAgent(BaseAgent):
    ...
    def search(self, research_brief: str, focus_areas: Optional[list[str]] = None) -> list[LiteratureEntry]:
        ...
        prompt = (
            ...
            f"Search your knowledge of research literature for techniques that could improve "
            f"this project's experimental setup. Focus on:\n"
            f"1. Techniques applicable to the current model and dataset\n"
            f"2. Methods that work within the configured compute budget\n"
            f"3. Recent advances and clear research gaps\n"
            f"4. Changes that can be implemented in the configured editable files\n\n"
            f"For each technique, assess how directly it can be applied to the "
            f"current configured editable files.\n\n"
